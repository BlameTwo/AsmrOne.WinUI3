...
public partial class ActivityFeedLayout : VirtualizingLayout
{
    ...
    protected override Size MeasureOverride(VirtualizingLayoutContext context, Size availableSize)
    {
        ...
        for (int rowIndex = firstRowIndex; rowIndex < lastRowIndex; rowIndex++)
        {
            ...
            for (int columnIndex = 0; columnIndex < 3; columnIndex++)
            {
                ...
                container.Measure(
                    new Size(
                        boundsForCurrentRow[columnIndex].Width,
                        boundsForCurrentRow[columnIndex].Height
                    )
                );
        ...
        var extentHeight =
            (context.ItemCount / 3 - 1) * (MinItemSize.Height + RowSpacing) + MinItemSize.Height;
    ...
    private Rect[] CalculateLayoutBoundsForRow(int rowIndex, double desiredItemWidth)
    {
        ...
        boundsForRow[0].Height =
            boundsForRow[1].Height =
            boundsForRow[2].Height =
                MinItemSize.Height;
