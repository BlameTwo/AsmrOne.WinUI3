...
//        var panelNative = Vanara.Windows.Shell.ComObject.As<ISwapChainPanelNative>(swapChainPanel);
...
//                (int)exStyle.SetFlags(User32.WindowStylesEx.WS_EX_LAYERED)
//            );
//        }
//    }

//    private static ID3D12Device CreateDevice(
//        out IDXGIFactory5 dxgiFactory5,
//        out IDXGIAdapter1 dxgiAdapter1
//    )
//    {
...
//        for (
//            uint adapterIndex = 0;
//            dxgiFactory5.EnumAdapters1(adapterIndex, out dxgiAdapter1) == Result.Ok;
//            ++adapterIndex
//        )
//        {
...
//        }
//        throw new System.Exception("´íÎó£¡");
//    }
...
//    private static bool SetPictureToLayeredWindow(
//        HWND hWnd,
//        nint hBitmap,
//        SIZE sizeBitmap,
//        POINT pos
...
//        var bRet = User32.UpdateLayeredWindow(
//            hWnd,
//            hDcScreen,
//            pos,
//            sizeBitmap,
